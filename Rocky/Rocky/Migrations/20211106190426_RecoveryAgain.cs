...
{
    public partial class RecoveryAgain : Migration
    {
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    Kinematic_Viscosity = table.Column<decimal>(type: "decimal(16,6)", nullable: false),
                    Vapor_Pressure = table.Column<decimal>(nullable: false),
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    table.PrimaryKey("PK_FluidPartMaterial", x => x.Id);
                });
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    Id = table.Column<int>(nullable: false)
                        .Annotation("SqlServer:Identity", "1, 1"),
                    FluidId = table.Column<int>(nullable: false),
                    FluidPartMaterialId = table.Column<int>(nullable: false),
                ...
                constraints: table =>
                {
                    ...
                    table.ForeignKey(
                        ...
                        column: x => x.FluidPartMaterialId,
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    DesignNumber = table.Column<string>(nullable: false),
                    Image = table.Column<string>(nullable: true),
                    CategoryId = table.Column<int>(nullable: false),
                    ApplicationTypeId = table.Column<int>(nullable: false),
                    Status = table.Column<string>(nullable: false),
                    Stroke_length = table.Column<double>(nullable: false),
                    Strokes = table.Column<double>(nullable: false),
                    Qapacity = table.Column<double>(nullable: false),
                    P2max = table.Column<double>(nullable: false),
                    P1 = table.Column<double>(nullable: false),
                    Power = table.Column<double>(nullable: false),
                    NPIPR = table.Column<double>(nullable: false),
                    DN = table.Column<double>(nullable: false),
                    Adjustable = table.Column<string>(nullable: true),
                    ExplosionProofPump = table.Column<string>(nullable: true),
                    FluidPartMatreialId = table.Column<int>(nullable: false),
                    TypePump = table.Column<string>(nullable: true),
                    TypePGA = table.Column<string>(nullable: true),
                    Volume = table.Column<float>(nullable: false),
                    P2PGA = table.Column<double>(nullable: false),
                    ExplosionProofPGA = table.Column<string>(nullable: true),
                    ConnectType = table.Column<string>(nullable: true),
                    Cell = table.Column<double>(nullable: false)
                },
                constraints: table =>
                {
                    ...
                    table.ForeignKey(
                        ...
                        column: x => x.FluidPartMatreialId,
                        principalTable: "FluidPartMaterial",
                        principalColumn: "Id",
                        onDelete: ReferentialAction.Cascade);
                });
